...
public class Base {
	...
	public WebDriver invokeBrowser() throws IOException {
		FileInputStream fis = new FileInputStream("C:\\Users\\Spoorthy\\eclipse-workspace\\HealthCare\\testdata\\configurations.properties");
		prop = new Properties();
		prop.load(fis);
		String browserName = prop.getProperty("browser");
	//	Dimension di = null;
		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver","C:\\Users\\Spoorthy\\eclipse-workspace\\HealthCare\\driver\\chromedriver.exe");
